...
export function run(): void {
  ...
  check(
    "共有帯のアイテムは剣 4 本・シアーズ・クワ 4 本・小麦の種・小麦・パン・鶏の肉 2 つ・羽根・卵・牛の肉 2 つ・革・糸・雪玉・鉱物の立方体 3 つ・ミルクバケツ・キノコ 2 種・ボウル・シチュー・サトウキビ・砂糖・はしご・リンゴ・紙・本・本棚・金のリンゴ・クモの巣・ケーキ・氷・フェンス・革の防具 4 部位の 45 個（161 まで）",
    sharedItems.length === 45 && sharedItems[4] === SHEARS && sharedItems[8] === DIAMOND_HOE &&
      ...
      // （フェンスまで 8 度目だったブロック側から）。`MAX_ITEM_ID` の突き合わせも
  ...
  check(
    "111..255 の空きは 94（革の防具 158..161 で 4 個減った）",
    sharedFree === 94,
    `${sharedFree} 個`,
  );
