...
import { run as breaking } from "./breaking.test";
import { run as bow } from "./bow.test";
import { run as chests } from "./chests.test";
import { run as controls } from "./controls.test";
import { run as crafting } from "./crafting.test";
import { run as crops } from "./crops.test";
...
import { run as items } from "./items.test";
